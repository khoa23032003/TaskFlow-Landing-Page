...
const MobileNav = ({ showNav, closeNav }: Props) => {
  ...
  return (
    <div>
      ...
      {/* NAVLINK  */}
      <div
        className={`text-white fixed ${navOpenCloseStyle} flex flex-col justify-center h-full transform transition-all duration-500 delay-300 w-[80%] sm:w-[60%] bg-red-600 space-x-6 z-1050`}
      >
        {NAVLINKS.map((link) => {
          return (
