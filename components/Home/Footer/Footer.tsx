        ...
        <div>
          ...
          <div className="space-y-6">
            <div className="flex items-start gap-4">
              ...
              <div>
                <p className="text-gray-800">Amsterdam</p>
            ...
            <div className="flex items-start gap-4">
              <span className="text-pink-500 text-xl">📞</span>
              <div>
                <p className="text-gray-800">+31 62 19 22 705</p>
                <p className="text-gray-500">7 Days - 8am - 10pm</p>
              </div>
            </div>

            <div className="flex items-start gap-4">
              <span className="text-pink-500 text-xl">✉️</span>
              <p className="text-gray-800">info@medcartel.com</p>
            </div>
          </div>
        </div>
        {/* 4nd Column  */}
